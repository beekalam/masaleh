    ...
    <div class="col-md-12">
        <div class="portlet box blue">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a href="javascript:;" class="btn btn-danger btn-sm btn-circle" id="new-user">
                        <i class="fa fa-plus"></i> کاربر جدید </a>
                    <?php if($isadmin): ?>
                        <a href="<?php echo base_url('admin/user/roles') ?>"
                ...
                <table border="0" class="table table-responsive table-bordered table-striped"
                    ...
                    <?php
                        foreach ($users as $value) {
                            ...
                            echo "</td>";
                            echo "<td>";
                            if($value["username"] !== 'admin' && $isadmin){
                ...
                <div class="modal fade" id="new-user-modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="<?php echo base_url('admin/user/new_user') ?>"
                                      id="">
                ...
                <div class="modal fade" id="change-role-modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="<?php echo base_url('admin/user/change_role') ?>"
                                      id=""d>
