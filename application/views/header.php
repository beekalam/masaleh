...
<head>
    ...
    <!--    <link href="-->
    <?php //echo base_url() ?><!--assets/global/plugins/fullcalendar/fullcalendar.min.css" rel="stylesheet"-->
    <!--          type="text/css"/>-->
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-default">
                            <li>
                                <a href="<?php
                                echo base_url('ui/user/profile') . "?id=" . $this->session->userdata("userid"); ?>"
    ...
    <div class="page-sidebar-wrapper">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false"
                ...
                <?php if (true): ?>
                    <li class="nav-item start" id="m-comments" style="display:none;">
                ...
                <?php if (true): ?>
                    <li class="nav-item start" id="m-customer-suggestions">
                        <a href="<?php echo base_url('ui/suggestions'); ?>" class="nav-link ">
                            <i class="icon-picture"></i>
                            <span class="title">انتقادات</span>
                            <span class="selected"></span>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <?php if (true): ?>
                    <li class="nav-item start" id="m-customer-suggestions">
                        <a href="<?php echo base_url('ui/Contactusmessages'); ?>" class="nav-link ">
                            <i class="icon-picture"></i>
                            <span class="title">پیام های سایت</span>
                            <span class="selected"></span>
                        </a>
                    </li>
                <?php endif; ?>
